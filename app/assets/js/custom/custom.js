...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        //                     // Update the user with a response message
        ...
        if (form) {
            form.addEventListener('submit', async function (event) {
                ...
                try {
                    ...
                    document.getElementById('responseMessage').innerHTML = `<p style="color: red;">Something wrong happens: ${error.message}</p>`;
                }
            });
        } else {
            console.error('Element with ID "contact-form" does not found.');
        }
